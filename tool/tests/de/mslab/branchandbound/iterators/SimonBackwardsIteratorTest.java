...
public class SimonBackwardsIteratorTest {
	
	private static BranchIterator iterator;
	private static final ActiveBits activeBits = new ActiveBits(new int[]{2,4,5,6,8,11,12,14}, new int[]{0,2,3,4});
	private static final int current = 130; // = 0b1000_0010;
	
	@BeforeClass
	public static void setUpBeforeClass() throws Exception {
		Cipher cipher = new Simon32();
		iterator = new SimonBackwardsIterator(cipher);
	...
	public void testCreateActiveBitsFromCurrent() {
		...
		final ActiveBits expectedActiveBits = new ActiveBits(new int[]{0,2,3,4}, new int[]{11,14});
